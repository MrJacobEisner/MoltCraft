...
RULES:
1. First, briefly describe what you plan to build and your approach in 1-3 short sentences. Then output exactly ONE Python code block with the build script. No other code blocks.
