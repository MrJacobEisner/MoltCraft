...
public class AIBuilderPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        String[] commands = {"claude", "openai", "gemini", "openrouter", "aihelp", "models"};
        ...
        getLogger().info("AI Builder Plugin enabled! Commands: /claude, /openai, /gemini, /openrouter, /aihelp, /models");
    }
