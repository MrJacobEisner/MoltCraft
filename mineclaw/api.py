...
def build_status_html(server_online, tunnel_running, bore_address, bots_active):
    ...
    token_display = API_TOKEN[:8] + "..." + API_TOKEN[-4:]
...
<div class="container">
    ...
    <div class="card">
        ...
        <code style="display:block;font-size:1rem;color:#60a5fa;background:#0d1117;padding:10px 16px;border-radius:8px;margin-top:8px;">{html_module.escape(token_display)}</code>
    </div>
